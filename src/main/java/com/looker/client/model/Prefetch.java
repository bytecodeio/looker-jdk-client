...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class Prefetch {
  ...
  * @return value
  **/
  @Schema(description = "Data associated with the queries stored by prefetching the data")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(ttl, createdAt, computationTime, resultSizeBytes, hitCount, touchedAt, value, url, can);
  }
