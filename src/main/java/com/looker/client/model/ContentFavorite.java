...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class ContentFavorite {
  ...
  * @return userId
  **/
  @Schema(description = "User Id which owns this ContentFavorite")
  ...
  **/
  @Schema(description = "Content Metadata Id associated with this ContentFavorite")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, userId, contentMetadataId, lookId, dashboardId, look, dashboard, can);
  }
