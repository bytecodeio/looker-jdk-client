...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class RenderTask {
  ...
  * @return id
  **/
  @Schema(description = "Id of this render task")
  public String getId() {
    return id;
  }
  /**
  ...
  * @return createdAt
  **/
  @Schema(description = "Date/Time render task was created")
  ...
  * @return finalizedAt
  **/
  @Schema(description = "Date/Time render task was completed")
  ...
  * @return status
  **/
  @Schema(description = "Render task status: enqueued_for_query, querying, enqueued_for_render, rendering, success, failure")
  ...
  * @return statusDetail
  **/
  @Schema(description = "Additional information about the current status")
  ...
  * @return userId
  **/
  @Schema(description = "The user account permissions in which the render task will execute")
  ...
  * @return runtime
  **/
  @Schema(description = "Total seconds elapsed for render task")
  ...
  * @return queryRuntime
  **/
  @Schema(description = "Number of seconds elapsed running queries")
  ...
  **/
  @Schema(description = "Number of seconds elapsed rendering data")
  ...
  * @return resultFormat
  **/
  @Schema(description = "Output format: pdf, png, or jpg")
  ...
  * @return lookId
  **/
  @Schema(description = "Id of look to render")
  ...
  * @return dashboardId
  **/
  @Schema(description = "Id of dashboard to render")
  ...
  **/
  @Schema(description = "Id of lookml dashboard to render")
  ...
  * @return queryId
  **/
  @Schema(description = "Id of query to render")
  ...
  * @return width
  **/
  @Schema(description = "Output width in pixels")
  ...
  * @return height
  **/
  @Schema(description = "Output height in pixels. Flowed layouts may ignore this value.")
  ...
  **/
  @Schema(description = "Dashboard layout style: single_column or tiled")
  ...
  **/
  @Schema(description = "Filter values to apply to the dashboard queries, in URL query format")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, createdAt, finalizedAt, status, statusDetail, userId, runtime, queryRuntime, renderRuntime, resultFormat, lookId, dashboardId, lookmlDashboardId, queryId, width, height, dashboardStyle, dashboardFilters, can);
  }
