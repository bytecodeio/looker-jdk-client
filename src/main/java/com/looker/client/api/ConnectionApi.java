...
import com.looker.client.model.DBConnection;
import com.looker.client.model.DBConnectionTestResult;
import com.looker.client.model.DialectInfo;
...
public class ConnectionApi {
    ...
    /**
     * Build call for deleteConnectionOverride
     * @param connectionName Name of connection (required)
     * @param overrideContext Context of connection override (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteConnectionOverrideCall(String connectionName, String overrideContext, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/connections/{connection_name}/connection_override/{override_context}"
            .replaceAll("\\{" + "connection_name" + "\\}", apiClient.escapeString(connectionName.toString()))
            .replaceAll("\\{" + "override_context" + "\\}", apiClient.escapeString(overrideContext.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteConnectionOverrideValidateBeforeCall(String connectionName, String overrideContext, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'connectionName' is set
        if (connectionName == null) {
            throw new ApiException("Missing the required parameter 'connectionName' when calling deleteConnectionOverride(Async)");
        }
        // verify the required parameter 'overrideContext' is set
        if (overrideContext == null) {
            throw new ApiException("Missing the required parameter 'overrideContext' when calling deleteConnectionOverride(Async)");
        }
        
        com.squareup.okhttp.Call call = deleteConnectionOverrideCall(connectionName, overrideContext, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String deleteConnectionOverride(String connectionName, String overrideContext) throws ApiException {
        ApiResponse<String> resp = deleteConnectionOverrideWithHttpInfo(connectionName, overrideContext);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> deleteConnectionOverrideWithHttpInfo(String connectionName, String overrideContext) throws ApiException {
        com.squareup.okhttp.Call call = deleteConnectionOverrideValidateBeforeCall(connectionName, overrideContext, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteConnectionOverrideAsync(String connectionName, String overrideContext, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteConnectionOverrideValidateBeforeCall(connectionName, overrideContext, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call testConnectionCall(String connectionName, List<String> tests, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (tests != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "tests", tests));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateConnectionCall(DBConnection body, String connectionName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateConnectionValidateBeforeCall(DBConnection body, String connectionName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateConnectionCall(body, connectionName, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DBConnection updateConnection(DBConnection body, String connectionName) throws ApiException {
        ApiResponse<DBConnection> resp = updateConnectionWithHttpInfo(body, connectionName);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DBConnection> updateConnectionWithHttpInfo(DBConnection body, String connectionName) throws ApiException {
        com.squareup.okhttp.Call call = updateConnectionValidateBeforeCall(body, connectionName, null, null);
        Type localVarReturnType = new TypeToken<DBConnection>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateConnectionAsync(DBConnection body, String connectionName, final ApiCallback<DBConnection> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateConnectionValidateBeforeCall(body, connectionName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DBConnection>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
