...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class CredentialsGoogle {
  ...
  * @return googleUserId
  **/
  @Schema(description = "Google's Unique ID for this user")
  ...
  * @return domain
  **/
  @Schema(description = "Google domain")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(email, googleUserId, domain, createdAt, loggedInAt, isDisabled, type, url, can);
  }
