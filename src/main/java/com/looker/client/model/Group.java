...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class Group {
  ...
  * @return userCount
  **/
  @Schema(description = "Number of users included in this group")
  ...
  **/
  @Schema(description = "Currently logged in user is group member")
  ...
  **/
  @Schema(description = "Group membership controlled outside of Looker")
  ...
  **/
  @Schema(description = "New users are added to this group by default")
  ...
  **/
  @Schema(description = "External Id group if embed group")
  ...
  **/
  @Schema(description = "Group can be used in content access controls")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, userCount, containsCurrentUser, externallyManaged, includeByDefault, externalGroupId, canAddToContentMetadata, can);
  }
