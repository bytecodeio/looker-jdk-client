...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class LookmlModelExploreFieldMapLayer {
  ...
  * @return url
  **/
  @Schema(description = "URL to the map layer resource.")
  ...
  * @return name
  **/
  @Schema(description = "Name of the map layer, as defined in LookML.")
  ...
  * @return featureKey
  **/
  @Schema(description = "Specifies the name of the TopoJSON object that the map layer references. If not specified, use the first object..")
  ...
  * @return propertyKey
  **/
  @Schema(description = "Selects which property from the TopoJSON data to plot against. TopoJSON supports arbitrary metadata for each region. When null, the first matching property should be used.")
  ...
  **/
  @Schema(description = "Which property from the TopoJSON data to use to label the region. When null, property_key should be used.")
  ...
  * @return projection
  **/
  @Schema(description = "The preferred geographic projection of the map layer when displayed in a visualization that supports multiple geographic projections.")
  ...
  * @return format
  **/
  @Schema(description = "Specifies the data format of the region information. Valid values are: \"topojson\", \"vector_tile_region\".")
  ...
  **/
  @Schema(description = "Specifies the URL to a JSON file that defines the geographic extents of each region available in the map layer. This data is used to automatically center the map on the available data for visualization purposes. The JSON file must be a JSON object where the keys are the mapping value of the feature (as specified by property_key) and the values are arrays of four numbers representing the west longitude, south latitude, east longitude, and north latitude extents of the region. The object must include a key for every possible value of property_key.")
  ...
  * @return maxZoomLevel
  **/
  @Schema(description = "The minimum zoom level that the map layer may be displayed at, for visualizations that support zooming.")
  ...
  * @return minZoomLevel
  **/
  @Schema(description = "The maximum zoom level that the map layer may be displayed at, for visualizations that support zooming.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.url, lookmlModelExploreFieldMapLayer.url) &&
        Objects.equals(this.name, lookmlModelExploreFieldMapLayer.name) &&
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(url, name, featureKey, propertyKey, propertyLabelKey, projection, format, extentsJsonUrl, maxZoomLevel, minZoomLevel);
  }
