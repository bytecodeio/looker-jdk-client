...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class DBConnectionTestResult {
  ...
  * @return status
  **/
  @Schema(description = "Result code of test")
  ...
  * @return message
  **/
  @Schema(description = "Result message of test")
  ...
  **/
  @Schema(description = "JDBC connection string. (only populated in the 'connect' test)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, status, message, connectionString, can);
  }
