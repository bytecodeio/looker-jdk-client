...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class IntegrationRequiredField {
  ...
  * @return tag
  **/
  @Schema(description = "Matches a field that has this tag.")
  ...
  * @return anyTag
  **/
  @Schema(description = "If present, supercedes 'tag' and matches a field that has any of the provided tags.")
  ...
  * @return allTags
  **/
  @Schema(description = "If present, supercedes 'tag' and matches a field that has all of the provided tags.")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(tag, anyTag, allTags);
  }
