...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class ContentView {
  ...
  * @return lookId
  **/
  @Schema(description = "Id of viewed Look")
  ...
  * @return dashboardId
  **/
  @Schema(description = "Id of the viewed Dashboard")
  ...
  **/
  @Schema(description = "Content metadata id of the Look or Dashboard")
  ...
  * @return userId
  **/
  @Schema(description = "Id of user content was viewed by")
  ...
  * @return groupId
  **/
  @Schema(description = "Id of group content was viewed by")
  ...
  * @return viewCount
  **/
  @Schema(description = "Number of times piece of content was viewed")
  ...
  **/
  @Schema(description = "Number of times piece of content was favorited")
  ...
  * @return lastViewedAt
  **/
  @Schema(description = "Date the piece of content was last viewed")
  ...
  **/
  @Schema(description = "Week start date for the view and favorite count during that given week")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, lookId, dashboardId, contentMetadataId, userId, groupId, viewCount, favoriteCount, lastViewedAt, startOfWeekDate, can);
  }
