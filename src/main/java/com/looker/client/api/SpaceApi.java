...
import com.looker.client.model.Space;
...
public class SpaceApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchSpacesCall(String fields, Integer page, Integer perPage, Integer limit, Integer offset, String sorts, String name, Integer id, String parentId, String creatorId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchSpacesValidateBeforeCall(String fields, Integer page, Integer perPage, Integer limit, Integer offset, String sorts, String name, Integer id, String parentId, String creatorId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Space> searchSpaces(String fields, Integer page, Integer perPage, Integer limit, Integer offset, String sorts, String name, Integer id, String parentId, String creatorId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Space>> searchSpacesWithHttpInfo(String fields, Integer page, Integer perPage, Integer limit, Integer offset, String sorts, String name, Integer id, String parentId, String creatorId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchSpacesAsync(String fields, Integer page, Integer perPage, Integer limit, Integer offset, String sorts, String name, Integer id, String parentId, String creatorId, final ApiCallback<List<Space>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call spaceChildrenCall(String spaceId, String fields, Integer page, Integer perPage, String sorts, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call spaceChildrenValidateBeforeCall(String spaceId, String fields, Integer page, Integer perPage, String sorts, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Space> spaceChildren(String spaceId, String fields, Integer page, Integer perPage, String sorts) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Space>> spaceChildrenWithHttpInfo(String spaceId, String fields, Integer page, Integer perPage, String sorts) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call spaceChildrenAsync(String spaceId, String fields, Integer page, Integer perPage, String sorts, final ApiCallback<List<Space>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateSpaceCall(Space body, String spaceId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateSpaceValidateBeforeCall(Space body, String spaceId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateSpaceCall(body, spaceId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Space updateSpace(Space body, String spaceId) throws ApiException {
        ApiResponse<Space> resp = updateSpaceWithHttpInfo(body, spaceId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Space> updateSpaceWithHttpInfo(Space body, String spaceId) throws ApiException {
        com.squareup.okhttp.Call call = updateSpaceValidateBeforeCall(body, spaceId, null, null);
        Type localVarReturnType = new TypeToken<Space>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateSpaceAsync(Space body, String spaceId, final ApiCallback<Space> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateSpaceValidateBeforeCall(body, spaceId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Space>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
