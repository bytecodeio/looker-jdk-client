...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class Datagroup {
  ...
  * @return id
  **/
  @Schema(description = "ID of the datagroup. Also used as the unique identifier.")
  public Long getId() {
    return id;
  }
  /**
  ...
  * @return name
  **/
  @Schema(description = "Name of the datagroup. Unique when combined with model_name.")
  ...
  * @return modelName
  **/
  @Schema(description = "Name of the model containing the datagroup. Unique when combined with name.")
  ...
  * @return triggerValue
  **/
  @Schema(description = "The value of the trigger when last checked.")
  ...
  * @return triggerError
  **/
  @Schema(description = "The message returned with the error of the last trigger check.")
  ...
  * @return staleBefore
  **/
  @Schema(description = "UNIX timestamp before which cache entries are considered stale. Cannot be in the future.")
  ...
  * @return triggeredAt
  **/
  @Schema(description = "UNIX timestamp at which this entry became triggered. Cannot be in the future.")
  ...
  **/
  @Schema(description = "UNIX timestamp at which this entry trigger was last checked.")
  ...
  * @return createdAt
  **/
  @Schema(description = "UNIX timestamp at which this entry was created.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, modelName, triggerValue, triggerError, staleBefore, triggeredAt, triggerCheckAt, createdAt, can);
  }
