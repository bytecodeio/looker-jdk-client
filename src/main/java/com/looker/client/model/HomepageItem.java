...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class HomepageItem {
  ...
  **/
  @Schema(description = "Associated Homepage Section")
  ...
  * @return order
  **/
  @Schema(description = "An arbitrary integer representing the sort order within the section")
  ...
  * @return title
  **/
  @Schema(description = "The actual title for display")
  ...
  * @return customTitle
  **/
  @Schema(description = "Custom title entered by the user, if present")
  ...
  **/
  @Schema(description = "Whether the custom title should be used instead of the content title, if the item is associated with content")
  ...
  * @return description
  **/
  @Schema(description = "The actual description for display")
  ...
  **/
  @Schema(description = "Custom description entered by the user, if present")
  ...
  **/
  @Schema(description = "Whether the custom description should be used instead of the content description, if the item is associated with content")
  ...
  * @return url
  **/
  @Schema(description = "The actual url for display")
  ...
  * @return customUrl
  **/
  @Schema(description = "Custom url entered by the user, if present")
  ...
  * @return useCustomUrl
  **/
  @Schema(description = "Whether the custom url should be used instead of the content url, if the item is associated with content")
  ...
  * @return imageUrl
  **/
  @Schema(description = "The actual image_url for display")
  ...
  **/
  @Schema(description = "Custom image_url entered by the user, if present")
  ...
  **/
  @Schema(description = "(Write-Only) base64 encoded image data")
  ...
  **/
  @Schema(description = "Whether the custom image should be used instead of the content image, if the item is associated with content")
  ...
  * @return lookId
  **/
  @Schema(description = "Look to base this item on")
  ...
  * @return dashboardId
  **/
  @Schema(description = "Dashboard to base this item on")
  ...
  **/
  @Schema(description = "LookML Dashboard to base this item on")
  ...
  * @return viewCount
  **/
  @Schema(description = "Number of times content has been viewed, if present")
  ...
  **/
  @Schema(description = "Number of times content has been favorited, if present")
  ...
  **/
  @Schema(description = "Name of user who created the content this item is based on")
  ...
  **/
  @Schema(description = "Last time the content that this item is based on was updated")
  ...
  **/
  @Schema(description = "Content favorite id associated with the item this content is based on")
  ...
  **/
  @Schema(description = "Content metadata id associated with the item this content is based on")
  ...
  **/
  @Schema(description = "Number of seconds it took to fetch the section this item is in")
