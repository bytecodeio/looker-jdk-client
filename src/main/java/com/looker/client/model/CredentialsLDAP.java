...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class CredentialsLDAP {
  ...
  * @return ldapId
  **/
  @Schema(description = "LDAP Unique ID for this user")
  ...
  * @return ldapDn
  **/
  @Schema(description = "LDAP Distinguished name for this user (as-of the last login)")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CredentialsLDAP credentialsLDAP = (CredentialsLDAP) o;
    return Objects.equals(this.email, credentialsLDAP.email) &&
        Objects.equals(this.ldapId, credentialsLDAP.ldapId) &&
        Objects.equals(this.ldapDn, credentialsLDAP.ldapDn) &&
        Objects.equals(this.createdAt, credentialsLDAP.createdAt) &&
        Objects.equals(this.loggedInAt, credentialsLDAP.loggedInAt) &&
        Objects.equals(this.isDisabled, credentialsLDAP.isDisabled) &&
        Objects.equals(this.type, credentialsLDAP.type) &&
        Objects.equals(this.url, credentialsLDAP.url) &&
        Objects.equals(this.can, credentialsLDAP.can);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(email, ldapId, ldapDn, createdAt, loggedInAt, isDisabled, type, url, can);
  }
