...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class ProjectError {
  ...
  * @return code
  **/
  @Schema(description = "A stable token that uniquely identifies this class of error, ignoring parameter values. Error message text may vary due to parameters or localization, but error codes do not. For example, a \"File not found\" error will have the same error code regardless of the filename in question or the user's display language")
  ...
  * @return severity
  **/
  @Schema(description = "Severity: fatal, error, warning, info, success")
  ...
  * @return kind
  **/
  @Schema(description = "Error classification: syntax, deprecation, model_configuration, etc")
  ...
  * @return message
  **/
  @Schema(description = "Error message which may contain information such as dashboard or model names that may be considered sensitive in some use cases. Avoid storing or sending this message outside of Looker")
  ...
  * @return fieldName
  **/
  @Schema(description = "The field associated with this error")
  ...
  * @return filePath
  **/
  @Schema(description = "Name of the file containing this error")
  ...
  * @return lineNumber
  **/
  @Schema(description = "Line number in the file of this error")
  ...
  * @return modelId
  **/
  @Schema(description = "The model associated with this error")
  ...
  * @return explore
  **/
  @Schema(description = "The explore associated with this error")
  ...
  * @return helpUrl
  **/
  @Schema(description = "A link to Looker documentation about this error")
  ...
  * @return params
  **/
  @Schema(description = "Error parameters")
  ...
  **/
  @Schema(description = "A version of the error message that does not contain potentially sensitive information. Suitable for situations in which messages are stored or sent to consumers outside of Looker, such as external logs. Sanitized messages will display \"(?)\" where sensitive information would appear in the corresponding non-sanitized message")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(code, severity, kind, message, fieldName, filePath, lineNumber, modelId, explore, helpUrl, params, sanitizedMessage);
  }
