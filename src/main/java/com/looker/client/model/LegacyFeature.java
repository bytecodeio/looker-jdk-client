...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class LegacyFeature {
  ...
  **/
  @Schema(description = "Whether this feature has been enabled by a user")
  ...
  * @return enabled
  **/
  @Schema(description = "Whether this feature is currently enabled")
  ...
  **/
  @Schema(description = "Looker version where this feature became a legacy feature")
  ...
  **/
  @Schema(description = "Looker version where this feature will be automatically disabled")
  ...
  **/
  @Schema(description = "Future Looker version where this feature will be removed")
  ...
  **/
  @Schema(description = "URL for documentation about this feature")
  ...
  **/
  @Schema(description = "Approximate date that this feature will be automatically disabled.")
  ...
  **/
  @Schema(description = "Approximate date that this feature will be removed.")
  ...
  **/
  @Schema(description = "Whether this legacy feature may have been automatically disabled when upgrading to the current version.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, description, enabledLocally, enabled, disallowedAsOfVersion, disableOnUpgradeToVersion, endOfLifeVersion, documentationUrl, approximateDisableDate, approximateEndOfLifeDate, hasDisabledOnUpgrade, can);
  }
