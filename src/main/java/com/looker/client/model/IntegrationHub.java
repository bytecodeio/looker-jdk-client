...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class IntegrationHub {
  ...
  * @return id
  **/
  @Schema(description = "ID of the hub.")
  public Long getId() {
    return id;
  }
  ...
  * @return url
  **/
  @Schema(description = "URL of the hub.")
  ...
  * @return label
  **/
  @Schema(description = "Label of the hub.")
  ...
  * @return official
  **/
  @Schema(description = "Whether this hub is a first-party integration hub operated by Looker.")
  ...
  **/
  @Schema(description = "An error message, present if the integration hub metadata could not be fetched. If this is present, the integration hub is unusable.")
  ...
  **/
  @Schema(description = "(Write-Only) An authorization key that will be sent to the integration hub on every request.")
  ...
  **/
  @Schema(description = "Whether the authorization_token is set for the hub.")
  ...
  **/
  @Schema(description = "Whether the legal agreement message has been signed by the user. This only matters if legal_agreement_required is true.")
  ...
  **/
  @Schema(description = "Whether the legal terms for the integration hub are required before use.")
  ...
  **/
  @Schema(description = "The legal agreement text for this integration hub.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, url, label, official, fetchErrorMessage, authorizationToken, hasAuthorizationToken, legalAgreementSigned, legalAgreementRequired, legalAgreementText, can);
  }
