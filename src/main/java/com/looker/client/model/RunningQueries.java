...
import com.looker.client.model.LookBasic;
import com.looker.client.model.Query;
import com.looker.client.model.SqlQuery;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class RunningQueries {
  ...
  * @return createdAt
  **/
  @Schema(description = "Date/Time Query was initiated")
  ...
  * @return completedAt
  **/
  @Schema(description = "Date/Time Query was completed")
  ...
  * @return source
  **/
  @Schema(description = "Source (look, dashboard, queryrunner, explore, etc.)")
  ...
  * @return queryTaskId
  **/
  @Schema(description = "ID of a Query Task")
  ...
  * @return message
  **/
  @Schema(description = "Additional Information(Error message or verbose status)")
  ...
  * @return runtime
  **/
  @Schema(description = "Number of seconds elapsed running the Query")
  ...
  * @return sql
  **/
  @Schema(description = "SQL text of the query as run")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, user, query, sqlQuery, look, createdAt, completedAt, queryId, source, nodeId, slug, queryTaskId, cacheKey, connectionName, dialect, connectionId, message, status, runtime, sql, can);
  }
