...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-02-15T12:39:13.185-08:00[America/Los_Angeles]")public class CredentialsEmbed {
  ...
  **/
  @Schema(description = "Embedder's unique id for the user")
  ...
  **/
  @Schema(description = "Embedder's id for a group to which this user was added during the most recent login")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CredentialsEmbed credentialsEmbed = (CredentialsEmbed) o;
    return Objects.equals(this.id, credentialsEmbed.id) &&
        Objects.equals(this.externalUserId, credentialsEmbed.externalUserId) &&
        Objects.equals(this.externalGroupId, credentialsEmbed.externalGroupId) &&
        Objects.equals(this.createdAt, credentialsEmbed.createdAt) &&
        Objects.equals(this.loggedInAt, credentialsEmbed.loggedInAt) &&
        Objects.equals(this.isDisabled, credentialsEmbed.isDisabled) &&
        Objects.equals(this.type, credentialsEmbed.type) &&
        Objects.equals(this.url, credentialsEmbed.url) &&
        Objects.equals(this.can, credentialsEmbed.can);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, externalUserId, externalGroupId, createdAt, loggedInAt, isDisabled, type, url, can);
  }
