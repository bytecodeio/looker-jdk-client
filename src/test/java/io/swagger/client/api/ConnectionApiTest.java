...
import com.looker.client.api.ConnectionApi;
...
public class ConnectionApiTest {
     ...
     */
    @Test
    public void deleteConnectionOverrideTest() throws ApiException {
        String connectionName = null;
        String overrideContext = null;
        String response = api.deleteConnectionOverride(connectionName, overrideContext);
    ...
    public void updateConnectionTest() throws ApiException {
        DBConnection body = null;
        String connectionName = null;
        DBConnection response = api.updateConnection(body, connectionName);
